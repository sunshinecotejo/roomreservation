...
<html>
	...
	<body>
		<nav class="navbar navbar-inverse">
        	...
        	<li><a href="roomreservation-webapp-0.0.1-SNAPSHOT/j_spring_security_logout"><span class="glyphicon glyphicon-log-out"></span>Logout</a></li>
        	</ul>
		</nav>
	 ...
	 <script type="text/javascript" >
		...
		(function ($) {
			...
			$.ajax({
				...
				//url : "http://localhost:8082/roomreservation-webapp-0.0.1-SNAPSHOT/viewScheduler/dummy",
