...
<script>
                    ...
                    $("#submit").click(
                        function(){
                        	 ...
                        	 //var selectedRoomIndex = document.getElementById('roomSelect').selectedIndex;
                        	 
                        	/*
                        	 var roomList ="${roomList}";
                        	                         	                        	 
                        	  var roomName = document.getElementById('roomSelect').options[document.getElementById('roomSelect').selectedIndex].text;
                        	  
                        	  alert(roomList[selectedRoomIndex].roomId + "\t" + roomName); */
                        	  ...
                        	  $.ajax({
                                  url: 'http://localhost:8082/roomreservation-webapp-0.0.1-SNAPSHOT/viewScheduler/create',
                                  type: 'POST',
